  ...
  return (
    <section id="about" className="section-container">
      ...
      >
        ...
        <p className="text-lg leading-relaxed text-muted-foreground">
          Across <strong className="text-foreground">20+ years</strong>, I've gone from zero-to-one (co-founding Urbotask, 5,000 users in 6 months) to enterprise transformation (<strong className="text-foreground">$2.1M+ revenue</strong> from GDPR platforms at Infosys) to national-scale infrastructure (250K+ Aadhaar API transactions). My edge: I move fluently between product strategy, hands-on AI prototyping, and regulatory complexity.
        </p>
        <p className="text-lg leading-relaxed text-muted-foreground">
