...
export const featuredProjects: Project[] = [
  ...
  {
    id: 'cadence-outreach',
    title: 'Cadence — AI Job Search Outreach System',
    tagline: 'Agentic system automating job-search prospecting, AI-powered company research, and personalized Gmail outreach',
    timeline: 'Personal AI Project · 2025',
    ...
    challenge: "Job searching at scale requires researching hundreds of companies, personalizing outreach for each, tracking responses — a manual process that takes weeks and is prone to repetition.",
    solution: "Built a local agentic system that automates the entire outreach pipeline: discovers companies and contacts via Apollo.io, runs AI-powered deep research on each prospect, generates personalized emails using Claude AI, and sends via Gmail — managed via a Flask CRM dashboard.",
    metrics: [
      { value: 'Automated', label: 'End-to-end outreach pipeline' },
      { value: 'AI-Powered', label: 'Company research & email generation' },
      { value: 'Gmail', label: 'Native send integration' },
      { value: 'Full CRM', label: 'Pipeline & response tracking' },
    ],
    businessImpact: [
      'Eliminates manual prospecting and research bottleneck',
      'Personalised AI-generated emails improve response rates',
      'Full pipeline visibility from prospect to reply',
      'Runs locally — no data sent to third-party SaaS tools',
    ],
    techStack: ['Python', 'Flask', 'SQLite', 'Gmail API', 'Apollo.io API', 'Claude AI', 'Jinja2', 'HTML/CSS'],
    skills: ['Agentic AI', 'API Integration', 'CRM Design', 'Workflow Automation', 'Product Development', 'Python Development'],
    featured: true,
  },
  {
    id: 'veriflow-dashboard',
    title: 'VeriFlow — Agentic Loan Processing Dashboard',
    tagline: '8-screen professional financial intelligence platform for Indian NBFC loan analysts with AI risk scoring and full audit trail',
    timeline: 'Personal AI Project · 2025',
    ...
    challenge: "Indian NBFC loan analysts manually review MSME applications with inconsistent risk assessment, no audit trail, and siloed workflows — creating compliance risk and slow turnaround times.",
    solution: "Designed and built an 8-screen interconnected agentic loan processing platform: prioritised queue with AI risk scores, unified applicant profile, flag detail with split-screen evidence, human override, final submission, credit officer view, branch manager dashboard, and full regulatory audit trail.",
    metrics: [
      { value: '8', label: 'Interconnected workflow screens' },
      { value: 'AI', label: 'Risk score & priority ranking' },
      { value: 'Human-in-Loop', label: 'Override & notes workflow' },
      { value: 'Full Audit', label: 'Regulatory compliance trail' },
    ],
    features: [
      {
        title: 'Analyst Workflow',
        items: [
          'Screen 1: Prioritised application queue with status badges and risk indicators',
          'Screen 2: Unified applicant profile with AI risk gauge and plain-language summary',
          'Screen 3: Flag detail split-screen — system finding vs. raw evidence side by side',
          'Screen 4: Human override & notes — analyst judgment recorded with reasoning',
          'Screen 5: Final recommendation submission to credit officer',
        ],
      },
      {
        title: 'Management & Compliance',
        items: [
          'Screen 6: Credit officer view — read-only review with full VeriFlow report',
          'Screen 7: Branch manager dashboard — queue health, TAT, flagged cases',
          'Screen 8: Audit trail — every agent action, API call, and human override logged',
        ],
      },
    ],
    businessImpact: [
      'End-to-end loan analyst workflow from queue to credit officer sign-off',
      'AI risk scoring with explainable flags and split-screen evidence view',
      'Human override capability preserves analyst judgment and accountability',
      'Regulatory-grade audit trail for every agent action and API call',
    ],
    techStack: ['TypeScript', 'React', 'Vite', 'Tailwind CSS', 'Agentic AI', 'Financial Data Modelling'],
    skills: ['Fintech Product Design', 'Agentic AI', 'UX/UI Design', 'NBFC Domain', 'Regulatory Compliance', 'Workflow Design'],
    featured: true,
  },
  {
    id: 'urbotask',
